...
##@ CLEANUP
###############################
clean_eval: ## Cleans up the intermediate files generated by the evaluation procedure.
	@rm -rf exp/hyperparams.yaml
	@rm -rf exp/embedding_model.ckpt
	@rm -rf exp/custom.py
	@rm -rf exp/asv_anon_ecapa_scratch/custom.py
	@rm -rf exp/asv_anon_ecapa_scratch/embedding_model.ckpt
	@rm -rf exp/asv_anon_ecapa_scratch/hyperparams.yaml
	@rm -rf exp/asv_anon_ecapa_ft/custom.py
	@rm -rf exp/asv_anon_ecapa_ft/embedding_model.ckpt
	@rm -rf exp/asv_anon_ecapa_ft/hyperparams.yaml

clean_eval_detailed: clean_eval ## Does a more detailed cleanup of the evaluation artifacts. This command is recommended to be run before running a new evaluation.
	@rm -rf exp/asr_pre_sb/*.txt
	@rm -rf exp/asr_pre_sb/libri*
	@rm -rf exp/asr_pre_sb/vctk*
	@rm -rf exp/asv_anon_ecapa_ft/*_out
	@rm -rf exp/asv_anon_ecapa_ft/*.txt
	@rm -rf exp/asv_anon_ecapa_ft/libri*
	@rm -rf exp/asv_anon_ecapa_ft/vctk*
	@rm -rf exp/asv_pre_ecapa/*_out
	@rm -rf exp/asv_pre_ecapa/*.txt
	@rm -rf exp/asv_pre_ecapa/libri*
	@rm -rf exp/asv_pre_ecapa/vctk*
	@rm -rf exp/asv_pre_ecapa_scratch/*_out
	@rm -rf exp/asv_pre_ecapa_scratch/*.txt
	@rm -rf exp/asv_pre_ecapa_scratch/libri*
	@rm -rf exp/asv_pre_ecapa_scratch/vctk*
